...
import { Calendar, Camera, Bell, CheckCircle, Moon, Sun, Share2, Clock, Archive, Globe } from "lucide-react"
...
export default function LandingPage() {
  ...
  // quick demo state for snooze options
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 text-slate-900 dark:text-gray-50 relative overflow-hidden">
      <div
        ...
        style={{
          background: "radial-gradient(circle at 10% 20%, rgba(59,130,246,0.06) 0%, transparent 25%), radial-gradient(circle at 90% 80%, rgba(139,92,246,0.04) 0%, transparent 20%)",
        }}
      />

      <header className="relative z-10 container mx-auto px-4 py-6 flex items-center justify-between">
        <Link href="/"  className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center text-white font-bold shadow-md">M</div>
      ...
      <main className="relative z-10 container mx-auto px-4 py-12">
        <section className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-lg text-slate-600 dark:text-gray-300 mb-6 max-w-2xl">
              Scan prescriptions, extract medicines with AI, and push smart reminders to your Google Calendar. Rich tracking, allergy checks, drug interaction alerts, and multi profile support make it great for families.
            </p>
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 rounded-2xl p-6 shadow-2xl">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-lg bg-blue-600 flex items-center justify-center text-white">AI</div>
                  <div>
              ...
              <div className="border border-dashed border-gray-200 dark:border-gray-700 rounded-lg p-3">
                ...
                <div className="mt-4 bg-gray-50 dark:bg-gray-900 rounded-md p-3">
                  <div className="text-xs text-slate-500 dark:text-gray-400 mb-2">Detected medicines</div>
                    ...
                    {snoozeMenuOpen && (
                      <div className="absolute mt-40 bg-white dark:bg-gray-900 rounded-lg p-3 shadow-lg right-6 w-48 z-20">
                        {snoozeOptions.map((opt) => (
                          <button key={opt} className="w-full text-left px-2 py-1 rounded hover:bg-gray-100 dark:hover:bg-gray-800">
                            {opt}
                          </button>
                        ))}
                      </div>
                ...
                <div className="mt-4 text-xs text-slate-500 dark:text-gray-400">Pro tip. Add your meal times in settings to have intelligent scheduling around food and sleep times.</div>
              </div>
            </div>
        ...
        <section id="features" className="mt-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800">
              ...
              <CardContent>
                <CardDescription>
                  Push automatic reminders to Google Calendar. Auto adjust for meals and sleep using your preferred meal times. Custom snooze options let you choose 30 minutes, 1 hour, tomorrow or set a custom time.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800">
              ...
              <CardContent>
                <CardDescription>
                  Store allergies and run drug interaction checks using public drug interaction APIs. We show clear warnings with recommended next steps and doctor share options.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800">
              ...
              <CardContent>
                <CardDescription>
                  A clear timeline of what you took in the last week or month. Exportable PDF to share with your doctor. Add notes for side effects or observations.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800">
              ...
              <CardContent>
                <CardDescription>
                  Track medications for family members or pets. Switch profiles quickly and see combined reminders on one calendar if desired.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800">
              ...
              <CardContent>
                <CardDescription>
                  Scan barcode or QR codes on medicine packaging to fetch dosage info instantly. Great for packaged prescriptions and over the counter meds.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800">
              ...
              <CardContent>
                <CardDescription>
                  Tesseract based OCR with support for multiple Indian languages and English. UI also supports translations so your elderly parents can use it comfortably.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
        ...
        <section className="mt-12">
          ...
          <p className="text-slate-600 dark:text-gray-300 mb-4 max-w-3xl">
            We designed MedRemind to keep your medical data private. Minimal data stays on device where possible, all exports are user triggered, and we provide clear controls over what is shared with Google Calendar or with your doctor.
          </p>
        ...
        <section className="mt-12 pb-24">
          ...
          <ul className="list-disc pl-6 text-slate-700 dark:text-gray-300">
            ...
            <li>Designing OCR pipeline with fallback heuristic extraction and human review for low confidence text</li>
            <li>Handling calendar sync failures idempotently so duplicate events are not created</li>
            <li>Drug interaction checks with cached external API results and alert throttling to avoid spamming users</li>
            <li>How multi profile and family calendar aggregation are modelled in Postgres schema</li>
      ...
      {showDemo && (
        <div className="fixed inset-0 z-40 flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-black opacity-50" onClick={() => setShowDemo(false)} />
          <div className="relative z-50 max-w-3xl w-full bg-white dark:bg-gray-900 rounded-xl p-6 shadow-2xl">
            <div className="flex items-start justify-between gap-4 mb-4">
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-gray-400">Play with sample scans and see how the calendar events and snooze options behave</p>
              </div>
              <button onClick={() => setShowDemo(false)} className="text-slate-500 dark:text-gray-300">Close</button>
            </div>

            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <div className="border rounded-lg p-4 bg-gray-50 dark:bg-gray-800">
                  <div className="text-sm text-slate-500 dark:text-gray-400 mb-2">Detected medicines</div>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between bg-white dark:bg-gray-900 p-3 rounded">
                      <div>
                        ...
                        <div className="text-xs text-slate-500 dark:text-gray-400">1 tablet every night</div>
                      </div>
                      <div className="text-right">
                        <div className="text-xs">Next dose</div>
                ...
                <div className="mt-4">
                  <div className="text-sm text-slate-500 dark:text-gray-400 mb-2">Snooze quick actions</div>
                  <div className="flex flex-wrap gap-2">
                    {snoozeOptions.map((opt) => (
                      <button key={opt} className="px-3 py-1 rounded bg-gray-100 dark:bg-gray-800 text-sm">
                        {opt}
                      </button>
                    ))}
                  </div>
              ...
              <div>
                <div className="border rounded-lg p-4 bg-gray-50 dark:bg-gray-800">
                  <div className="text-sm text-slate-500 dark:text-gray-400 mb-2">Interaction alerts</div>
                  <div className="bg-white dark:bg-gray-900 p-3 rounded">
                    ...
                    <div className="text-xs text-slate-500 dark:text-gray-400 mt-2">We check against public APIs and flag known issues</div>
                  </div>

                  <div className="mt-4 text-xs text-slate-500 dark:text-gray-400">Exportable PDF and CSV make it easy to share with your doctor</div>
                </div>
              </div>
            </div>

            <div className="mt-6 text-right">
              <Button onClick={() => setShowDemo(false)} size="sm" className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white">Close demo</Button>
            </div>
          </div>
        </div>
      )}
